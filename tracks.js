const TRACKS = [
  ...
  },
  {
    ...
    sentences: [
      ...
      { start: 20.56, end: 23.65, text: "usually expressed in global hectares." },
      { start: 23.65, end: 26.56, text: "By comparing ecological footprints," },
      { start: 26.56, end: 34.00, text: "we can understand how different lifestyles and practices contribute to resource depletion and environmental degradation." },
      { start: 34.00, end: 42.52, text: "For instance, the ecological footprint of someone living in a developed country is typically larger than that of someone living in a developing country," },
      { start: 42.52, end: 46.16, text: "mainly due to higher consumption levels and waste production." },
      { start: 46.16, end: 56.40, text: "Factors such as energy use, transportation, food consumption, and housing play significant roles in determining the size of an ecological footprint." },
      { start: 56.40, end: 62.29, text: "Understanding ecological footprints is crucial for promoting sustainability." },
      { start: 62.29, end: 68.58, text: "It helps identify areas where changes can be made to reduce environmental impact." },
      { start: 68.58, end: 79.59, text: "For example, if you consume locally produced foods, you'll likely reduce your ecological footprint because less energy will be used for transporting that food." },
