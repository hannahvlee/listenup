const TRACKS = [
  ...
  },
  {
    ...
    sentences: [
      { start: 5.00, end: 13.70, text: "An ecological footprint is a measure of the environmental impact of an individual, community, or country." },
      { start: 13.70, end: 20.50, text: "It calculates the amount of natural resources consumed and the waste generated by human activities," },
      { start: 20.50, end: 23.65, text: "usually expressed in global hectares." },
      { start: 23.65, end: 26.55, text: "By comparing ecological footprints," },
      { start: 26.55, end: 33.96, text: "we can understand how different lifestyles and practices contribute to resource depletion and environmental degradation." },
      { start: 33.96, end: 42.41, text: "For instance, the ecological footprint of someone living in a developed country is typically larger than that of someone living in a developing country," },
      { start: 42.41, end: 46.15, text: "mainly due to higher consumption levels and waste production." },
      { start: 46.15, end: 56.21, text: "Factors such as energy use, transportation, food consumption, and housing play significant roles in determining the size of an ecological footprint." },
      { start: 56.21, end: 62.27, text: "Understanding ecological footprints is crucial for promoting sustainability." },
      { start: 62.27, end: 68.44, text: "It helps identify areas where changes can be made to reduce environmental impact." },
      { start: 68.44, end: 79.62, text: "For example, if you consume locally produced foods, you'll likely reduce your ecological footprint because less energy will be used for transporting that food." },
      { start: 79.59, end: 88.03, text: "Governments and organizations can use ecological footprint data to develop policies aimed at achieving sustainable development." },
      { start: 88.03, end: 90.00, text: "I'll discuss some examples of that next." },
    ],
    vocab: [
